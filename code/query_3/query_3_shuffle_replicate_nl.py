...
geocoding_df = (
    ...
    .withColumn("ZIP_CODE", F.split(col("ZIP_CODE"), ";").getItem(0))
)
...
crime_with_zip_df = crime_2015_df.hint("shuffle_replicate_nl").join(
    geocoding_df.hint("shuffle_replicate_nl"),
    ((crime_2015_df.LAT == geocoding_df.LAT) & (crime_2015_df.LON == geocoding_df.LON)),
    how = "left",
)


crime_with_zip_df = crime_with_zip_df.select(
    crime_2015_df["LAT"],
    crime_2015_df["LON"],
    crime_2015_df["Vict Descent"],
    geocoding_df["ZIP_CODE"],
)
